$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        ...
        var locationurl2 = window.location.pathname;
        var nameapp = locationurl2.split("/");
        if (themeName == 'classic') {
            $('#bs-css').attr('href', "http://"+locationurl+"/"+nameapp[1]+"/"+'/assets/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', "http://"+locationurl+"/"+nameapp[1]+"/"+'/assets/css/bootstrap-' + themeName + '.min.css');
