...
<!--HandSonTable -->
<script src="<?=base_url()?>assets/bower_components/handsontable/dist/handsontable.full.js"></script>
<!--<script src="<?=base_url()?>assets/js/jquery.handsontable.removeRow.js"></script>-->
